                ...
                <div class="card text-black" style="border-radius:10px;">
                    ...
                    <div class="card-body p-md-0 mx-md-5" style="text-align: center;">
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <input style="width: 50%" type="text" name="name" id="name" value="{{ $service->name }}" required>
                            <br>
                            <label style="width: 12%" for="price">Price:</label>
                            <input style="width: 50%" type="number" name="price" id="price" value="{{ $service->price }}" required>
                            <br>
                            <label style="width: 12%" for="description">Description:</label>
                            <textarea style="width: 50%" name="description" id="description" required>{{ $service->description }}</textarea>
                            <br>
                            <label style="width: 12%" for="image">Image:</label>
                            <input style="width: 50%" type="file" name="image" id="image">
                            <br>
                            <br>
                            <input type="submit" class="btn btn-primary btn-block fa-lg gradient-custom-2" value="Update Service">
                        </form>
                    </div>
                </div>
            </div>
